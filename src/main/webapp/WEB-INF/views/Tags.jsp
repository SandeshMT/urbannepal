<%-- 
    Document   : Tags
    Created on : Jan 2, 2017, 1:29:45 PM
    Author     : myhp
--%>
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Post Tags <small>Add New Tags</small></h2>
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <form class="form-horizontal form-label-left input_mask" action="submittagsdetails" method="POST">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Name</label>
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" placeholder="Tags Name" name="tagsname">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <textarea name="description" class="resizable_textarea form-control" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 87px;" placeholder="This text area automatically resizes its height">
                                                        </textarea>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Post Tags <small>Post Tag Details</small></h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                                </li>
                                                <li class="dropdown">
                                        ...
                                        <table id="mytable" class="table table-striped responsive-utilities jambo_table bulk_action">
                                            ...
                                            <tbody>
                                            <c:forEach items="${tagsdetails}" var="tg">
                                                <tr class="even pointer">
                                                    <td class="a-center "><input type="checkbox" class="flat" name="table_records" ></td>
                                                    <td class=" ">${tg.name}</td>
                                                    <td class=" ">${tg.slug}</td>
                                                    <td class=" ">${tg.description}</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
