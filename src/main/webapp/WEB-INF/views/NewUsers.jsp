<%-- 
    Document   : NewUsers
    Created on : Jan 5, 2017, 12:09:31 PM
    Author     : myhp
--%>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <form class="form-horizontal form-label-left input_mask" action="newprofessional" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group form-group has-feedback">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Conform Password<span class="required">*</span></label>
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" placeholder="Re-enter Password" name="confpassword">
                                                        <span class="fa fa-eye form-control-feedback right" aria-hidden="true"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group has-feedback">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" placeholder="Details About your profession" name="profession">
                                                ...
                                                <div class="form-group form-group has-feedback">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <textarea class="resizable_textarea form-control" name="biography" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 87px;" placeholder="This text area automatically resizes its height">
                                                            </textarea>
                                                        </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Urban Nepal <small>Add Editors</small></h2>
                                            <ul class="nav navbar-right panel_toolbox">
                                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                                </li>
                                                <li class="dropdown">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <form class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Username<span class="required">*</span></label>
                                                    <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                                        <input type="text" class="form-control" placeholder="Userame">
                                                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
