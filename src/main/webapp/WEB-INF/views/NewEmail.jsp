<%-- 
    Document   : NewEmail
    Created on : Feb 16, 2017, 4:47:52 PM
    Author     : myhp
--%>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Add Mail<small>Provide Descriptions</small></h2>
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="savenewemail" method="POST" enctype="multipart/form-data">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><strong>Subject:</strong></label>
                                                    <input type="text" placeholder="Enter Email Subject" name="subject" class="form-control">
                                                </div>
                                                <div class="clearfix"></div>
