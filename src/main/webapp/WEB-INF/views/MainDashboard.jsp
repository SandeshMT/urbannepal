                    ...
                    <div class="col-md-8 col-sm-8">
                        <div class="home_text">
                            ...
                            <div class="download-btn">
                                <!-- BUTTON -->
                                <a class="btn home-btn wow fadeInLeft">Service At Your FingerTips</a><br/><br/>
                                <a class="tuor btn wow fadeInRight">Select The Service <i class="fa fa-angle-down"></i></a>
                                <!--                                <input type="text" name="serviceName" style="height: 50px; width: 300px;">-->
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" name="serviceName" id="autocomplete-custom-append" class="form-control col-md-10" style="float: left;" />
                                    <a href="serviceWizards"><button class="btn btn-success">GO</button></a>
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (results) {
                    'use strict';
                    console.log(results);
                    var lists = $.makeArray(results, function (i, items) {
                        return{
                            value: i,
                            data: items.serviceName
                        };
                    });
