<%-- 
    Document   : EditContactInfo
    Created on : Jan 6, 2017, 1:18:54 PM
    Author     : myhp
--%>
                                        ...
                                        <div class="x_content">
                                            ...
                                            <form class="form-horizontal form-label-left input_mask">
                                                ...
                                                <div class="form-group form-group has-feedback">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" placeholder="Primary Number">
                                                ...
                                                <div class="form-group form-group has-feedback">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" placeholder="Secondary Number">
                                                         <span class="fa fa-phone form-control-feedback right" aria-hidden="true"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group has-feedback">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" placeholder="Primary Address">
                                                ...
                                                <div class="form-group form-group has-feedback">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" placeholder="Secondary Address">
                                                        <span class="fa fa-home form-control-feedback right" aria-hidden="true"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group form-group has-feedback">
