<%-- 
    Document   : EditEmail
    Created on : Feb 16, 2017, 4:49:14 PM
    Author     : myhp
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit Email Details</title>
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Mail Details<small>Edit Email Details</small></h2>
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="updateemail" method="POST" >
                                            <c:forEach items="${emaildetails}" var="ed">
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><strong>Email ID:</strong></label>
                                                    <input type="text" name="emaiID" id="emailid" value="${ed.emailId}" class="form-control" readonly>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><strong>Subject:</strong></label>
                                                    <input type="text" name="subject" value="${ed.subject}" class="form-control">
                                                </div>
                                                <div class="clearfix"></div>
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12"><strong>Message:</strong></label>
                                                <div class="clearfix"></div>
                                                <textarea id="elm1" name="message">${ed.content}</textarea>
                                                <div class="clearfix"></div>
                                                <div class="control-group" form-group style="float: left">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Image Attachment</label>
                                                    <div class="clearfix"></div>
                                                    <div id="image-holder">
                                                    <img src="${ed.featuredImage}" style="height: 70px; width: 70px;" />
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="clearfix"></div>
                                                    <button type="button" id="cfibtn" class="btn btn-primary">Change Image</button>
                                                    <div class="clearfix"></div>
