<%-- 
    Document   : NewService
    Created on : Jan 4, 2017, 7:49:32 PM
    Author     : myhp
--%>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="newService" method="POST" class="form-horizontal form-label-left" >

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="service-name">Service Name</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="serviceName" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
