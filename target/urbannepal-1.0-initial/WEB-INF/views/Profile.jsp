<%-- 
    Document   : Profile
    Created on : Jan 5, 2017, 12:13:02 PM
    Author     : myhp
--%>
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                                <c:forEach items="${contactdetails}" var="usr">
                                                ...
                                                <div class="profile_img">
                                                    ...
                                                    <div id="crop-avatar">
                                                        ...
                                                        <div class="avatar-view" title="Change the avatar">
                                                            <img src="${usr.profilepicture}" alt="Avatar">
                                                        </div>
                                                    ...
                                                    <!-- end of image cropping -->
                                                            ...
                                                            <h3>${usr.firstname} &nbsp; ${usr.lastnanme}</h3>
                                                <ul class="list-unstyled user_data">
                                                    <li><i class="fa fa-map-marker user-profile-icon"></i> ${usr.primaryaddress}
                                                    </li>

                                                    <li>
                                                        <i class="fa fa-briefcase user-profile-icon"></i> ${usr.profession}
                                                    </li>
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                ...
                                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                        ...
                                                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Services Worked on</a>
                                                        </li>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                                                            ...
                                                            <c:forEach items="${userdetails}" var="usrdtls">
                                                                ...
                                                                <div class="form-group form-group has-feedback">
                                                                    ...
                                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                                            <textarea class="resizable_textarea form-control" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 87px;" readonly>
                                                                            ${usrdtls.biographicalInformation}
                                                                            </textarea>
                                                                        </div>
