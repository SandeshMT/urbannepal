<%-- 
    Document   : Categories
    Created on : Jan 2, 2017, 1:28:01 PM
    Author     : myhp
--%>
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Post Categories <small>Add New Category</small></h2>
                                        ...
                                        <div class="x_content">
                                            <br />
                                            <form class="form-horizontal form-label-left input_mask" action="submitcatdetails" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <select class="form-control" name="parent">
                                                            <option></option>
                                                        <c:forEach items="${catdetails}" var="cat">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <textarea class="resizable_textarea form-control" name="description" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 87px;" placeholder="This text area automatically resizes its height">
                                                    </textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Post Categories <small>Post Categories Details</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li class="dropdown">
                                        ...
                                        <tbody>
                                            <c:forEach items="${catdetails}" var="cat">
                                                <tr class="even pointer">
                                                    ...
                                                    <td class=" ">${cat.categoryname}</td>
                                                    <td class=" ">${cat.slug}</td>
                                                    <td class=" ">${cat.parent}</i></td>
